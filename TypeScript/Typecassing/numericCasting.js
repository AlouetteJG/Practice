...
var courses = ["April", "May", "June", "July"];
...
var myBool = false; //A boolean is set, and it can be use by its value.
var x = myBool.toString(); //With toString we can visualize as string the value inside myBool
console.log(x); // False is print as string.
